				...
				<form>
					<div class="label-margin">
						...
						<label> <input type="password" name="password"
							id="password" placeholder="비밀번호를 입력하세요" class="size password"
							value=""> <input type="hidden" id="upassword"
							name="upassword" value="${member.password}">
						</label>
					</div>
					...
					<div class="label-margin">
						...
						<label> <textarea name="reason"
								placeholder="탈퇴 이유를 입력해주세요" class="size border-bottom" required></textarea>
						</label>
					</div>
					...
					<div class="caution">
						...
						<p>
							- 회원탈퇴 시 관련 데이터가 모두 삭제되며<br> 탈퇴 후에는 복구가 어렵습니다.
						</p>
					</div>
