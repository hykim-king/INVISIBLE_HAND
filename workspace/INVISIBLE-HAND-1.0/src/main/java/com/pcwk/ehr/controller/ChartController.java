...
public class ChartController {
	...
	@RequestMapping(value = "/chart01.do", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String chartGraph(
			@RequestParam(value = "mainCategory", required = false, defaultValue = "비제조업") String mainCategory,
	...
	@RequestMapping(value = "/chart02.do", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String chart02Graph(
			@RequestParam(value = "mainCategory", required = false, defaultValue = "제조업") String mainCategory,
			@RequestParam(value = "subCategory", required = false, defaultValue = "-") String subCategory) {
		String jsonString02 = "";
		ChartVO inVO = new ChartVO();
		inVO.setMaincategory(mainCategory);
	...
	@RequestMapping(value = "/chart03.do", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String chart03Graph(
			@RequestParam(value = "mainCategory", required = false, defaultValue = "제조업") String mainCategory,
			@RequestParam(value = "subCategory", required = false, defaultValue = "-") String subCategory) {
		String jsonString03 = "";
		ChartVO inVO = new ChartVO();
	...
	@RequestMapping(value = "/chart04.do", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String chart04Graph(
			@RequestParam(value = "mainCategory", required = false, defaultValue = "제조업") String mainCategory,
			@RequestParam(value = "subCategory", required = false, defaultValue = "-") String subCategory) {
		String jsonString04 = "";
		ChartVO inVO = new ChartVO();
	...
	public String soultionChart(@RequestParam(value = "mainCategory") String mainCategory,
		...
		inVO.setMaincategory(mainCategory);
		inVO.setSubcategory(subCategory);
		List<ChartVO> chartDataSol = chartSerivce.soultionChart(inVO);
		JsonArray mainArraySol = new JsonArray();

		for (ChartVO outVO : chartDataSol) {
			JsonArray sArray = new JsonArray();
			sArray.add(outVO.getChartdate());
			sArray.add(outVO.getMaincategory());
			sArray.add(outVO.getSubcategory());
